...
while(<STDIN>)
{
    ...
    elsif( $data_array[0] eq "receiver")
    {
	    $receiver_num += $data_array[1];
    }
}
print("INSERT INTO " . $mysql_table . " (DATES,TYPES,DIME,VAL) VALUES (" . $date . "," ."\"SHARE\"". "," . "\"ALL\"" . "," . $sendmessage_count. ");\n"); 
print("INSERT INTO " . $mysql_table . " (DATES,TYPES,DIME,VAL) VALUES (" . $date . "," ."\"RECEIVE\"". "," . "\"ALL\"" . "," . $receiver_num. ");\n"); 
