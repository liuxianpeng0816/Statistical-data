...
print("CREATE TABLE IF NOT EXISTS " . $mysql_table . " (DATES datetime, TYPES char(20), DIME char(64), VAL bigint(20) ,constraint PK_".$mysql_table." primary key clustered (DATES,TYPES,DIME)) ;" . "\n");
...
while(<STDIN>)
{
    ...
    #print("INSERT INTO " . $mysql_table . " (DATES,TYPES,DIME,VAL) VALUES (" . $date . "," . "\"". "ACTIVE" ."\"". "," . "\"" ."ALL" ."\"". "," . "\"".$active_use_time. "\"".");\n");
