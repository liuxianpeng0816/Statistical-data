...
print("CREATE TABLE IF NOT EXISTS " . $mysql_table1 . " (DATES date  not null,TYPES char(20),DIME char(20),VAL integer  null,constraint PK_".$mysql_table1." primary key clustered (DATES, TYPES, DIME)) ;" . "\n"); 
print("CREATE TABLE IF NOT EXISTS " . $mysql_table2 . " (DATES date  not null,TYPES char(20),DIME char(40),PLAYVAL integer  null,CHATVAL integer  null,MSGVAL integer  null,constraint PK_".$mysql_table2." primary key clustered (DATES, TYPES,DIME)) ;" . "\n"); 
