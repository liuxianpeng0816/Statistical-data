...
foreach my $key(keys %privatemessage_number)
{
    ...
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"DIALOG_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"DIALOG_NUM\" AND DATES <= \"".$date."\";\n");
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"CREATESUBJECT_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"CREATESUBJECT_NUM\" AND DATES <= \"".$date."\";\n");
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"CREATEWISH_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"CREATEWISH_NUM\" AND DATES <= \"".$date."\";\n");
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"TEXT_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"TEXT_NUM\" AND DATES <= \"".$date."\";\n");
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"VOICE_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"VOICE_NUM\" AND DATES <= \"".$date."\";\n");
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"IMAGE_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"IMAGE_NUM\" AND DATES <= \"".$date."\";\n");
    print("INSERT INTO " . $mysql_table . " SELECT \"". $date ."\",\"ASSISTANT_TOTAL\", \"ALL\" ,sum(VAL) FROM ". $mysql_table ." WHERE TYPES=\"ASSISTANT_NUM\" AND DATES <= \"".$date."\";\n");
